// Local DS41 C6 adaptation: 24 physical rows / 144 routed slots, ABI 2.
...
constexpr int H = 5120, I = 1152, TOPK = 6, ROWS_MAX = 24;
...
// Buffers have capacity 144 routed slots and 24 output rows, prepared before capture.
