...
Pool *ds41_display_create(size_t ordinary,size_t display) {
    ...
    if(ordinary>1024UL*1024*1024||display!=1792UL*1024*1024||ordinary%quantum) {
        snprintf(error_text,sizeof(error_text),"Expected <=1GiB ordinary in64KiB units and1.75GiB display");return NULL;
    }
