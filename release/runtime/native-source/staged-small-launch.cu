...
std::vector<int64_t> ds41_small_staged_resources() {
    ...
    ds41_small_staged::resources<true>(values);ds41_small_staged::resources<false>(values);
    selected_device=device;
    return values;
}

void ds41_small_staged_forward(const at::Tensor& x,const at::Tensor& out,
    ...
    using namespace ds41_small_staged;
