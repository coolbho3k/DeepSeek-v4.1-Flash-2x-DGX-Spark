...
ATTENTION_DESCRIPTOR = {'implementation': 'image_safe_packed_sparse_attention_v2', 'kernel_sha256': '22839ccef76d501a9191b193a522429dcfe98ae9977f31f51be04455ea51d9e9', 'registration_sha256': '4a8ada8fddc38570c98e907afe35e1606691aab48d1945440e854b0c1105df52', 'query_dtype': 'bfloat16', 'probability_bf16_terms': 2, 'partial_dtype': 'float32', 'lse_base': 2, 'main_cache_format': 'fp4', 'swa_cache_format': 'fp8', 'image_visibility_unchanged': True}
...
def verify_native_engram_binding(model):
    ...
    for module in model.modules():
        ...
        if (not 0<stage.staging_bytes<=hook.DESCRIPTOR['staging_bytes_per_layer_ceiling']
                or stage.staging_bytes!=cap*536 or stage.ids.numel()!=cap
