...
CORE_SHA = '79e771e79820c439478ccb51187b329639eb88e2555d31eed4ade9987cd324e7'
DESCRIPTOR = dict(layout='page15', gpu_readable_host=True, deferred_retrieval=True, row_bytes_unchanged=True, reader_abi=2, implementation='miaai_parallel_native_engram_v1', license='AGPL-3.0-only',
